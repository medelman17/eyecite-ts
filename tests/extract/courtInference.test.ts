...
describe("inferCourtFromReporter", () => {
  describe("federal supreme", () => {
    it.each([
      ...
      "L. Ed.",
      "L. Ed. 2d",
    ])("infers supreme/federal for %s", (reporter) => {
    ...
    it.each([
      ...
      "L.Ed. 2d",
      "L. Ed.2d",
    ])("infers supreme/federal for spacing variant %s", (reporter) => {
      const result = inferCourtFromReporter(reporter)
      expect(result).toEqual({
        level: "supreme",
        jurisdiction: "federal",
  ...
  describe("federal appellate", () => {
    it.each([
      ...
      "F.4th",
      "F. App'x",
    ])("infers appellate/federal for %s", (reporter) => {
      const result = inferCourtFromReporter(reporter)
      expect(result).toEqual({
        level: "appellate",
        jurisdiction: "federal",
  ...
  describe("federal trial", () => {
    it.each([
      ...
      "F.R.D.",
      "B.R.",
    ])("infers trial/federal for %s", (reporter) => {
      const result = inferCourtFromReporter(reporter)
      expect(result).toEqual({
        level: "trial",
        jurisdiction: "federal",
  ...
  describe("california", () => {
    it.each([
      ...
      "Cal.4th",
      "Cal.5th",
    ])("infers supreme/state/CA for %s", (reporter) => {
    ...
    it.each([
      ...
      "Cal.App.4th",
      "Cal.App.5th",
    ])("infers appellate/state/CA for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "appellate",
        jurisdiction: "state",
        state: "CA",
    ...
    it.each([
      ...
      "Cal.Rptr.2d",
      "Cal.Rptr.3d",
    ])("infers unknown/state/CA for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "unknown",
        jurisdiction: "state",
        state: "CA",
  ...
  describe("new york", () => {
    it.each(["N.Y.", "N.Y.2d", "N.Y.3d"])("infers supreme/state/NY for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "supreme",
        jurisdiction: "state",
        state: "NY",
    ...
    it.each(["A.D.", "A.D.2d", "A.D.3d"])("infers appellate/state/NY for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "appellate",
        jurisdiction: "state",
        state: "NY",
    ...
    it.each(["Misc.", "Misc.2d", "Misc.3d"])("infers trial/state/NY for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "trial",
        jurisdiction: "state",
        state: "NY",
    ...
    it.each(["N.Y.S.", "N.Y.S.2d", "N.Y.S.3d"])("infers unknown/state/NY for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "unknown",
        jurisdiction: "state",
        state: "NY",
  ...
  describe("illinois", () => {
    ...
    it.each([
      ...
      "Ill.App.2d",
      "Ill.App.3d",
    ])("infers appellate/state/IL for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "appellate",
        jurisdiction: "state",
        state: "IL",
  ...
  describe("ohio", () => {
    it.each([
      ...
      "Ohio St.2d",
      "Ohio St.3d",
    ])("infers supreme/state/OH for %s", (reporter) => {
      expect(inferCourtFromReporter(reporter)).toEqual({
        level: "supreme",
        jurisdiction: "state",
        state: "OH",
